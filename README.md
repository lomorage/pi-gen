...
Once startup, it already setup wifi in AP mode and bridge between wifi (wlan) and ethernet (eth0) ports. You can plug in the ethernet port to your local network, you can then ping `raspberry.local` to get the ip address of the emulator.
